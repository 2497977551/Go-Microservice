...
var file_simple_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x75, 0x74, 0x65, 0x22, 0x23, 0x0a, 0x0d, 0x53, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x52,
	...
	0x12, 0x36, 0x0a, 0x05, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x12, 0x14, 0x2e, 0x72, 0x6f, 0x75, 0x74,
	0x65, 0x2e, 0x53, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	0x15, 0x2e, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x2e, 0x53, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x09, 0x5a, 0x07, 0x2e, 0x3b, 0x72, 0x6f,
...
var file_simple_proto_goTypes = []interface{}{
	...
	(*SimpleResponse)(nil), // 1: route.SimpleResponse
}
var file_simple_proto_depIdxs = []int32{
	0, // 0: route.Simple.Route:input_type -> route.SimpleRequest
	1, // 1: route.Simple.Route:output_type -> route.SimpleResponse
...
func (c *simpleClient) Route(ctx context.Context, in *SimpleRequest, opts ...grpc.CallOption) (*SimpleResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/route.Simple/Route", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
